...
<html>
  ...
  <table border="0" cellpadding="0" cellspacing="4" width="100%" style="margin-bottom: 5px; margin-top: 5px; border: 1px solid gray;">
    <tbody>
      <tr>
        <td align=center style="font-size: 10px; font-family: Verdana; border: 1px dashed gray;">
          <a href="<?php echo "http://$base_website_address"; ?>" title="Lezioni di chitarra, guide di teoria e tecnica, spartiti, testi e accordi di canzoni"> CERCA </a>
        </td>
        <td align=center>
          <!-- LINK BAR -->
        ...
        <td align=center style="font-size: 10px; font-family: Verdana; border: 1px dashed gray;">
          <a href="http://<?php echo "$base_website_address/"?>amici.html" target="_top">SITI AMICI</a>
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
	...
	src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
		...
		src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
          ...
          <table border="0" cellspacing="0" cellpadding="5" style="border: 1px solid blue; margin-top: 5px; margin-bottom: 5px; ">
            <tr>
              <td>
                <strong><a href="http://<?php echo $base_website_address; ?>" target="_top">Torna al menù principale</a></strong>
              </td>
            </tr>
          </table>

        </td>
        <td valign=top width=120 style="border: 1px solid gray; padding: 4px">
