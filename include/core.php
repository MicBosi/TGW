...
-->\n");
  ...
  function write_bookmarks($row)
  {
    echo "<div align=center>BOOKMARK PAGE</div><div align=center>";
    
    global $header;
    global $base_website_address;

    $bookmark_title = urlencode($header['title']);
    $bookmark_url = urlencode("http://".$base_website_address.$_SERVER['REQUEST_URI']);

    ?>
    <script language="JavaScript">
    <!--
      var testo = "Aggiungi ai Preferiti"
      var applicazione = navigator.appName
      var versione = parseInt(navigator.appVersion)
      var indirizzo = this.location;
      var titolo = document.title;
      if ((versione >= 4)&&(applicazione == "Microsoft Internet Explorer")) { // MSIE
         document.write('<div style="margin:0px; padding:0px; border:0px; margin-bottom:5px"><A HREF="javascript:window.external.AddFavorite(indirizzo,titolo);" ');
         document.write('onMouseOver=" window.status=')
         document.write("testo; return true ")
         document.write('"onMouseOut=" window.status=')
         document.write("' '; return true ")
         document.write('">'+ testo + '</a></div>')
      } else
      if (window.sidebar) { // Firefox
         document.write('<div style="margin-bottom:5px"><A HREF="javascript:window.sidebar.addPanel(titolo, indirizzo,\'\');" ');
         document.write('onMouseOver=" window.status=')
         document.write("testo; return true ")
         document.write('"onMouseOut=" window.status=')
         document.write("' '; return true ")
...
function receive_email($destination_mail, $fake_from_mail, $allowed_address)
{
  ...
  $mailsent = mail("$destination_mail",
       "$mailsubject",
       "$messagebody",
       "From: $email\nReply-To: $email");

  $copysent = mail("$email",
       "Mail inviata: $mailsubject",
       "$replymessage",
  ...
  ?>
<form name="mailform" align="center" method="post" action="<?php echo $receiver_script; ?>">
    <table style="<?php echo $table_style; ?>" width="550" cellspacing="5">
    
    <?php if ($params['show_name'] == TRUE) { ?>
    <tr>
      <td align="right">
        <span style="<?php echo $note_style; ?>">Nome</span>
      </td>
      <td>
        <input style="<?php echo $text_style; ?>" size="35" name="name" value="<?php echo $params['name'];?>">
      </td>
    </tr>
    <?php } ?>
    
    <?php if ($params['show_email'] == TRUE) { ?>
    <tr>
      <td align="right">
        <span style="<?php echo $star_style; ?>">*</span><span style="<?php echo $note_style; ?>">e-mail</span>
      </td>
      <td align="left">
        <input style="<?php echo $text_style; ?>" size="35" name="email">
      </td>
    </tr>
    <tr align="middle">
      <td align="right">
        <span style="<?php echo $star_style; ?>">*</span><span style="<?php echo $note_style; ?>">Conferma e-mail</span>
      </td>
      <td align="left">
        <input style="<?php echo $text_style; ?>" size="35" name="confirmMail">
      </td>
    </tr>
    <?php } ?>
    ...
    <tr>
      <td align="right">
        <span style="<?php echo $star_style; ?>">*</span><span style="<?php echo $note_style; ?>">Titolo del messaggio</span>
      </td>
      <td>
        <input style="<?php echo $text_style; ?>" size="35" name="mailsubject" value="<?php echo $testo_subject?>">
      </td>
    </tr>
    <?php
    }
    ...
    <tr>
      <td align="right" valign=top>
        <span style="<?php echo $star_style; ?>">*</span><span style="<?php echo $note_style; ?>">Messaggio</span>
        <?php
        if ($testo_subject != "")
      ...
      <td>
        <textarea style="<?php echo $text_style; ?>" name="messagebody" rows="9" cols="50"><?php echo $testo_messaggio; ?></textarea>
      </td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      ...
      <span style="<?php echo $note_style; ?>">I campi obbligatori sono contrassegnati da un </span><span style="<?php echo $star_style; ?>">*</span>
      <br>
