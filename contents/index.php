                ...
                <tbody>
                    ...
                    <tr>
                        <td style="border: 0px solid gray;" colspan=4 id="content-index">
                            ...
                            <h1>introduzione alla chitarra</h1>
                            <p>Queste prime lezioni di chitarra ti guideranno verso i concetti base necessari a compiere i primi passi nello studio
                            ...
                            <ul>
                                <li>
                                    <a title="propositi su questo corso di chitarra" href="propositi.html">Obbiettivi del corso di chitarra</a>
                                </li>
                                <li>
                                    <a title="introduzione al corso di chitarra e spartiti" href="gwintro.html">Intro al corso di chitarra</a>
                                </li>
                                <li>
                                    <a title="come studiare e imparare a suonare la chitarra" href="gwpercorsi.html">Percorsi</a>
                                </li>
                            </ul>
                            <h2>la chitarra</h2>
                            <ul>
                            ...
                            <h2>leggere gli spartiti</h2>
                            <ul>
                                <li>
                                    <a title="posizioni delle note sulla chitarra" href="pentagramma_note.html">Pentagramma, Note e Spartiti</a>
                                </li>
                                <li>
                                    <a title="come leggere il tempo sugli spartiti" href="tempi_e_ritmi.html">Il Tempo</a>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>
                                    <a title="accordi base per chitarra" href="primi_accordi.html">Primi Accordi</a>
                                </li>
                                <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a title="posizioni della scala minore sulla chitarra" href="s_naturale.html">Scala Minore Naturale</a>
                                </li>
                                <li>
                                    <a title="posizioni della scala armonica sulla chitarra" href="s_armonica.html">Scala Minore Armonica</a>
                                </li>
                                <li>
                                    <a title="posizioni della scala melodica sulla chitarra" href="s_melodica.html">Scala Minore Melodica</a>
                                </li>
                                <li>
                                    <a title="posizioni della scala pentatonica sulla chitarra" href="s_pentatonica.html">Scala Pentatonica</a>
                                </li>
                                <li>
                                    <a title="suonare la scala blues sulla chitarra" href="s_blues.html">Scale Blues</a>
                                </li>
                                <li>
                                    Scala Cromatica
                                </li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a title="esercizi di tecnica per suonare con lo sweep picking" href="sweep_intro.html">Sweep Picking</a>
                                </li>
                                <li>
                                    Tapping
                                </li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <br>
                                    <br>
                                    SCIOGLIMENTO DELLE DITA
                                </li>
                                <li>
                                    Esercizi Fuori Dalla Tastiera
                                </li>
                                <li>
                                    24 Patterns
                                </li>
                                <li>
                                    Patterns Di Divisione a 3 dita
                                </li>
                                <li>
                                ...
                                <li>
                                    <a title="esercizi per sciogliere le dita e pattern principali" href="3_pattern_principali.html">I Pattern Principali</a>
                                </li>
                                <li>
    ...
    <tbody>
        ...
        <tr>
            <td style="border: 1px solid gray;" valign="top" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: normal; font-size: 16px">
                    <a href="link_didattica.html">DIDATTICA ON LINE</a>
                </h1>
                ...
                breve presentazione di ognuno di essi.
            </td>
            <td style="border: 1px solid gray;" valign="middle" align="center" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: bold; font-size: 16px">
                    <a title="tutti i testi, accordi, tablature, spartiti per chitarra che cerchi" href="testi-canzoni-accordi-tablature-e-spartiti-per-chitarra.html">TESTI DI CANZONI, ACCORDI, TABLATURE E SPARTITI PER CHITARRA</a>
                </h1>
            ...
            <td style="border: 1px solid gray;" valign="top" align="right" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: normal; font-size: 16px">
                    <a href="link_accademie.html">SCUOLE DI MUSICA</a>
                </h1>
        ...
        <tr>
            <td style="border: 1px solid gray;" valign="top" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: normal; font-size: 16px">
                    <a href="link_software.html">SOFTWARE &amp; HARDWARE</a>
                </h1>
            ...
            <td style="border: 1px solid gray;" valign="top" align="center" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: normal; font-size: 16px">
                    <a href="link_ascolti.html">ASCOLTI SUGGERITI</a>
                </h1>
                ...
                che li troverai interessanti.
            </td>
            <td style="border: 1px solid gray;" valign="top" align="right" width="33%">
                <h1 style="padding: 0px; margin: 0px; font-weight: normal; font-size: 16px">
                    <a href="link_vari.html">VARI</a>
                </h1>
                Qui troverai un elenco di collegamenti ordinati per
                categorie, di varia (e dubbia) utilità.
            </td>
        </tr>
    </tbody>
</table>
