...
description: Questa lezione mostra lo sviluppo delle triadi maggiori sulla tastiera della chitarra.
title: Triade maggiore
-->
<h1 class="title"><?php echo $header['title']; ?></h1>

<font size=5>D</font>i seguito viene riportato lo schema generale della triade maggiore lungo la tastiera della chitarra con i primi schemi dei rivolti della triade presi uno a uno sulle varie corde.<br>
Per capire l'importanza di questi schemi basti pensare che molti chitarristi basano gran parte della loro improvvisazione solo sulle triadi.<br>
